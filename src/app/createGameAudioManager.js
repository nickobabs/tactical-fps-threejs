...
const GAME_AUDIO_REGISTRATIONS = [
  ...
  ['knife-draw', '/audio/guns/knife/knifedraw.mp3', { playback: 'interrupt', baseVolume: 0.3 }],
  [
    'sniper-zoom',
    '/audio/guns/awp-zoom-sound-effect-cs-go.mp3',
    { playback: 'interrupt', minIntervalMs: 80 },
  ],
  ['knife-slash-1', '/audio/guns/knife/knifeswing1.mp3', { playback: 'interrupt' }],
  ['knife-slash-2', '/audio/guns/knife/knifeswing2.mp3', { playback: 'interrupt' }],
  ['knife-slash-3', '/audio/guns/knife/knifeswing3.mp3', { playback: 'interrupt' }],
