...
const SMOKE_PUFF_LAYOUT = [
  [0.0, 0.64, 0.0, 3.26, 0.48, 0.03, 0.01],
  [-0.56, 0.58, -0.26, 2.84, 0.45, -0.01, -0.01],
  [0.62, 0.56, 0.18, 2.82, 0.45, 0.01, 0.01],
  [-1.66, 0.54, -0.32, 2.68, 0.42, -0.03, 0.0],
  [1.74, 0.52, -0.24, 2.62, 0.41, 0.03, -0.01],
  [-1.18, 0.5, 1.3, 2.5, 0.39, -0.02, 0.02],
  [1.28, 0.46, 1.26, 2.46, 0.39, 0.02, 0.02],
  [-0.24, 0.56, -1.58, 2.48, 0.4, -0.01, -0.03],
...
const SMOKE_RISE_DISTANCE = 0.02;
